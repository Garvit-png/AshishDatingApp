...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen bg-black overflow-hidden flex items-center pt-16">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-black via-black/90 to-red-950/40 z-10" />
      ...
      <div className="absolute right-0 top-0 h-full w-1/2 z-0">
        <Image
          ...
          priority
        />
        {/* Gradient fade from right to black */}
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
        <div className="max-w-2xl">
          ...
          {/* Subtitle */}
          <p className="text-gray-300 text-base sm:text-lg mb-10 max-w-md leading-relaxed opacity-0 animate-slide-up" style={{ animationDelay: "0.45s", animationFillMode: "forwards" }}>
